const addRemoveButtons = () => {
  ...
  const quitParent = quitBtn.parentElement
  quitBtn.remove()

  const btn = document.createElement('button')
  btn.style.display = 'flex'
  btn.title = 'run code inside enclave'
  btn.addEventListener('click', () => alert('sending code to enclave (not really)'))
  btn.innerHTML = `
